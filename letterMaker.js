...
let mySkills1 = ["javaScript", "react", "ruby", "redux"]
...
skill1 = (companyDetails) => {
	let companyDetailsCleaned = companyDetails.toLowerCase().replace(regexComma, "").split(" ");
	let matchingSkills = mySkills1.filter(x => !companyDetailsCleaned.includes(x));
	return matchingSkills;
}
// console.log(skill1(companyDetails))

console.log(`Hi ${companyContact()},
I saw the ${jobTitle} position at ${companyName} in ${companyLocation()}, and am extremely interested. I've included my resume, and when comparing my skills to the qulifications, feel that I would be a great fit for this position. I've always had a strong desire and passion for the ${companyType} industry.

I would love to be part of a team in a ${companySize(companyCount)} company${teamFiller(companySize(companyCount))}.
\n
I noticed the request for ${skill1(companyDetails)[0].toString()} and ${skill1(companyDetails)[1].toString()}. I love those tools and think you'll find some of my recent projects relevant (www.elijahsamuels.com). 
